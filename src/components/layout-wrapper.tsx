    ...
    <>
      <div className="flex min-h-screen relative max-w-[1600px] mx-auto">
        ...
        <nav className="fixed bottom-6 left-1/2 -translate-x-1/2 bg-[var(--card-bg)]/90 backdrop-blur-xl border border-[var(--glass-border)] rounded-full px-6 py-3 shadow-2xl flex items-center gap-6 md:gap-8 z-50">
           <Link href="/" className="text-[var(--muted-foreground)] hover:text-primary transition-colors flex flex-col items-center gap-1">
             <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="m3 9 9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"/><polyline points="9 22 9 12 15 12 15 22"/></svg>
             <span className="text-[10px] font-semibold">Calc</span>
           </Link>
           <Link href="/range" className="text-[var(--muted-foreground)] hover:text-primary transition-colors flex flex-col items-center gap-1">
           ...
           <Link href="/tco" className="text-[var(--muted-foreground)] hover:text-primary transition-colors flex flex-col items-center gap-1">
           ...
           <Link href="/map" className="text-[var(--muted-foreground)] hover:text-primary transition-colors flex flex-col items-center gap-1">
